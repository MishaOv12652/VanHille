...
export class CloudlinksService {
  ...
  getAllCloudLinkTables() {
    ...
    return this.http.get(`${environment.url}CloudLinks/getAllCloudLinks`, {headers: headers}).map(res => res.json());
  }
  ...
  addCloudLinkTable(table) {
    ...
    return this.http.post(`${environment.url}CloudLinks/addCloudLinkTable`, table, {headers: headers}).map(res => res.json());
  }
  ...
  addEntryToCloudLinkTable(id, newTableData) {
    ...
    return this.http.post(`${environment.url}CloudLinks/${id}`, newTableData, {headers: headers}).map(res => res.json());
  }
  ...
  deleteEntryFromCloudTable(id, deletedTableData) {
    ...
    //   .map(res => res.json());
    return this.http.post(`${environment.url}CloudLinks/deleteEntry/${id}`, deletedTableData, {headers: headers})
      .map(res => res.json());
  }
  ...
  deleteCloudLinkTable(id) {
    ...
    return this.http.delete(`${environment.url}CloudLinks/${id}`, {headers: headers}).map(res => res.json());
  }
